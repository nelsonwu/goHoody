	...
	$(document).ready(function() {
		$('#file_upload').uploadify({
			...
			'onComplete': function(event, queueID, fileObj, response, data) 
			{
				...
				$("#uploaded_preview").append("<img class='preview_pic' src=\'<?php echo $domain_secondary;?>resizer.php?src=<?php echo $domain_secondary;?>service_pictures/" +json.url + "&w=100&h=100&zc=1\' width=\'100px\' height=\'100px\' />");
  ...
  <div id="content">
   ...
   <div id = "tabs_block">
    ...
    <div id='tab_container'>
      <form id="Upload" action="<?php if($listing_exist) {echo($working_directory.'upload_process.php?lid='.$lid);} else{echo($working_directory.'upload_process.php');} ?>" 
      ...
      <div id='tab2_content' class='Step_2_location'>
        ...
        <div id='radio_address'>
          ...
          <div id='checkbox_home'>
              <img class='box_checked_home' src="<?php echo $domain_secondary;?>attachements/radio_check.png" />
              <img class='box_unchecked_home' src="<?php echo $domain_secondary;?>attachements/box_uncheck.png" />
          </div>
          ...
          <div id='checkbox_away'>
              <img class='box_checked_away' src="<?php echo $domain_secondary;?>attachements/radio_check.png" />
              <img class='box_unchecked_away' src="<?php echo $domain_secondary;?>attachements/box_uncheck.png" />
          </div>
          ...
          <div id='checkbox_virtual'>
              <img class='box_checked_virtual' src="<?php echo $domain_secondary;?>attachements/radio_check.png" />
              <img class='box_unchecked_virtual' src="<?php echo $domain_secondary;?>attachements/box_uncheck.png" />
          </div>
...
?>
            ...
            <div id='restrictions'>
                ...
                <div><b>Maximum file size:</b> up to 1.5MB per picture</div>
                <div><b>Maximum image dimension:</b> up to 2500x2500 </div>
            </div>
        </div> 
       </fieldset>
