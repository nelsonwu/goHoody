<?php
	...
	$page_title = "Hoody for UofT | Services for students, by students.";
?>
...
<meta name="Keywords" content="Hoody, GoHoody, Student Services, UofT, Trusted Services, Social Integration, Post a service, Local classifieds, Social classifieds"  />
...
<!--Facebook meta properties -->
    <meta property="og:title" content="Hoody - UofT"/>
    ...
    <meta property="og:description"
          content="Services for students, by students."/>

<![if !IE]>
<link rel="stylesheet" href="<?php echo $working_directory; ?>css/uoft.css" type="text/css"/>
<![endif]>
<!--[if gte IE 6]>
<link rel="stylesheet" href="<?php echo $working_directory; ?>css/uoft_ie.css" type="text/css"/>
<![endif]-->
	...
	?>    
  	<div class='content'> 
    	<div id='panels'>
          <?php if ($user): ?>
              <div id='left_panel'>
                  ...
                  <div id='post_section'>
                  	<div id='placeholder_text'> What is your skill? </div>
                  	<form id="create" action="<?php echo $working_directory; ?>create/" method="post">
                    	<input id="post_service_input" name="service_title" type="text" placeholder="What is your skill?"/>
                        <button type='submit' id='post_service_button' name="submit">Create Page</button>
                    </form>
                  </div>
                  <div id='suggestion_sect'>
                  	<div id='popular_text'> Skills being promoted right now: </div>
          ...
          <div id='left_panel'>
              <div id='headline1'>Have a special skill? <br />Sell yourself!</div>
          ...
          <div id='right_panel'>
            <div id='panel1'>
              <div class='panel_img'><img src="<?php echo $domain_secondary; ?>attachements/skills.png" /></div>
              <div class='panel_text1'>Hone your skills</div>
              <div class='panel_text2'>Gain valuable experience and feedback to improve your skills. </div>
              
            </div>
            
            <div id='panel2'>
              <div class='panel2_img'><img src="<?php echo $domain_secondary; ?>attachements/connect.png" /></div>
        ...
        <div id='title_section'>
            ...
            <div class='title_text'> What other students are promoting on Hoody: </div>
                    
        </div> <!--end #title_section-->
        ...
        <div id='partners_sect'>
        
        	<div class='title_text'> Our partners </div>
            
            <div class='partner'>	
                <img class='partner_img' src='<?php echo $domain_secondary;?>attachements/CESA.png'  />
            </div> <!--end .partner-->
            
            <div class='partner'>	
                <img class='partner_img' src='<?php echo $domain_secondary;?>attachements/hacker.png'  />
            </div> <!--end .partner-->
            
            
            
            <div class='partner'>	
                <img class='partner_img' src='<?php echo $domain_secondary;?>attachements/web_startup.png'  />
            </div> <!--end .partner-->
            
            <div class='partner2'>	
                <img class='partner_img' src='<?php echo $domain_secondary;?>attachements/ECC.png'  />
            </div> <!--end .partner-->
            
        
        </div> <!--end #partners_sect-->
